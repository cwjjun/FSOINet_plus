...
def main():
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        loss = train(train_loader, model, criterion, args.sensing_rate, optimizer, device, scaler)
        if args.sensing_rate == 0.5:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-b', '--batch_size', default=6, type=int, help='mini-batch size (default: 128)')
